...
#define PCD_SOFTRESET					0x0F   //Reset the MFRC522
...
#define MFRC522_REG_RESERVED01			0x0F	// reserved for future use

//Page 1: Communication - UART
...
#define MFRC522_REG_RX_MODE				0x13	// defines transmission data rate and framing
